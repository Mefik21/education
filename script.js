...
window.addEventListener('DOMContentLoaded', function () {
  ...
  slider.render();
  var sliderModulesPage = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.moduleapp',
    btns: '.next',
    nextArrow: '.nextmodule',
    prevArrow: '.prevmodule'
  });
  sliderModulesPage.render();
...
/*#__PURE__*/
function () {
  function Difference(oldOffices, newOffices, items) {
    _classCallCheck(this, Difference);

    this.oldOffices = document.querySelector(oldOffices);
    this.newOffices = document.querySelector(newOffices);

    try {
      this.oldItems = this.oldOffices.querySelectorAll(items);
      this.newItems = this.newOffices.querySelectorAll(items);
    } catch (error) {}
  ...
  _createClass(Difference, [{
    key: "bindTriggers",
    value: function bindTriggers(container, counter, arrItems) {
      container.querySelector('.plus').addEventListener('click', function () {
        if (counter !== arrItems.length - 2) {
          arrItems[counter].style.display = 'flex';
          arrItems[counter].classList.add('animated', 'fadeIn');
          counter++;
        } else {
          arrItems[counter].style.display = 'flex';
          arrItems[counter].classList.add('animated', 'fadeIn');
          arrItems[arrItems.length - 1].classList.add('animated', 'fadeOut');
        }
      });
    }
  }, {
    key: "hideitems",
    value: function hideitems(arrayItems) {
      arrayItems.forEach(function (item, i, arr) {
        if (i !== arr.length - 1) {
    ...
    value: function init() {
      try {
        ...
        this.bindTriggers(this.oldOffices, this.oldCounter, this.oldItems);
        this.bindTriggers(this.newOffices, this.newCounter, this.newItems);
      } catch (error) {}
    }
  }]);
...
function () {
  ...
  _createClass(Forms, [{
    ...
    value: function createMask(event) {
      function setCursorPosition(pos, elem) {
        ...
        if (elem.setSelectionRange) {
          ...
          range.collapse(true); // Объединяет граничные точки диапозона начальное и конечное

          range.moveEnd('character', pos + 2); //Конечная точка выделения

          range.moveStart('character', pos + 2); //Начальная точка выделения
      ...
      var matrix = '+1 (___) ___-____',
          ...
          // Default value
      val = this.value.replace(/\D/g, ''); // Inputs Value
    ...
    value: function checkEmail() {
      ...
      mailInput.forEach(function (item) {
    ...
    value: function init() {
      ...
      try {
        ...
        this.phoneInput.forEach(function (input) {
      ...
      this.forms.forEach(function (item) {
        item.addEventListener('submit', function (e) {
          ...
          statusMessage.textContent = _this.message.load;
...
function (_Slider) {
  ...
  function MainSlider(btns, nextArrow, prevArrow) {
    _classCallCheck(this, MainSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, btns, nextArrow, prevArrow));
  }
  ...
  _createClass(MainSlider, [{
    ...
    value: function render() {
      ...
      if (this.container) {
        ...
        this.nextArrow.forEach(function (item) {
          item.addEventListener('click', function (e) {
            e.stopPropagation();
            e.preventDefault();
        ...
        this.prevArrow.forEach(function (item) {
          item.addEventListener('click', function (e) {
            e.stopPropagation();
            e.preventDefault();
...
function (_Slider) {
  ...
  function MainSlider(container, next, prev, animate, activeClass) {
    var _this;

    _classCallCheck(this, MainSlider);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, container, next, prev, animate, activeClass));
    _this.containerSelector = container;
    return _this;
  }
  ...
  _createClass(MainSlider, [{
    ...
    value: function nextSlide() {
      ...
      try {
        this.btns = document.querySelectorAll(".".concat(this.container.className, " > button"));
        this.btns.forEach(function (btn) {
          _this3.container.appendChild(btn);
        });
      } catch (error) {}
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      nextArrow = _ref$nextArrow === void 0 ? null : _ref$nextArrow,
      _ref$prevArrow = _ref.prevArrow,
      prevArrow = _ref$prevArrow === void 0 ? null : _ref$prevArrow;
  ...
  this.nextArrow = document.querySelectorAll(nextArrow);
  this.prevArrow = document.querySelectorAll(prevArrow);
};
